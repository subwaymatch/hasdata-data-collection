...
_ZP_TOP_LEVEL_MAPPED: set[str] = {
    ...
    # newly mapped
    "availableFrom", "buildingId", "contingentListingType",
    "fees", "leaseTerm", "openHouseSchedule",
}
...
_ZP_RESO_MAPPED: set[str] = {
    ...
    # newly mapped scalars
    "aboveGradeFinishedArea", "additionalParcelsDescription", "associationFee",
    "availabilityDate", "bathroomsOneQuarter", "bathroomsThreeQuarter",
    "builderModel", "buildingAreaSource", "carportParkingCapacity", "commonWalls",
    "cumulativeDaysOnMarket", "fencing", "hasAssociation", "hasCarport",
    "hasPetsAllowed", "hasWaterfrontView", "hoaFee", "hoaFeeTotal",
    "irrigationWaterRightsYN", "leaseTerm", "levels", "listAOR",
    "livingAreaRangeUnits", "mainLevelBathrooms", "mainLevelBedrooms",
    "propertyCondition", "storiesTotal", "structureType", "virtualTour",
    "waterView", "waterViewYN", "yearBuilt", "yearBuiltEffective",
    "zoning", "zoningDescription",
    # newly mapped containers
    "associations", "doorFeatures", "greenBuildingVerificationType",
    "greenEnergyEfficient", "greenEnergyGeneration", "greenWaterConservation",
...
def upsert_zillow_property(item_id: str, url: str, raw_json: dict) -> None:
    ...
    (
        ZillowProperty.insert(
            ...
            available_from=p.get("availableFrom"),
            building_id=p.get("buildingId"),
            contingent_listing_type=p.get("contingentListingType"),
            fees=p.get("fees"),
            lease_term=p.get("leaseTerm"),
            open_house_schedule=p.get("openHouseSchedule"),
            # Additional resoData scalar fields
            reso_above_grade_finished_area=reso.get("aboveGradeFinishedArea"),
            reso_additional_parcels_description=reso.get("additionalParcelsDescription"),
            reso_association_fee=reso.get("associationFee"),
            reso_availability_date=_ms_to_datetime(reso.get("availabilityDate")),
            reso_bathrooms_one_quarter=reso.get("bathroomsOneQuarter"),
            reso_bathrooms_three_quarter=reso.get("bathroomsThreeQuarter"),
            reso_builder_model=reso.get("builderModel"),
            reso_building_area_source=reso.get("buildingAreaSource"),
            reso_carport_parking_capacity=reso.get("carportParkingCapacity"),
            reso_common_walls=reso.get("commonWalls"),
            reso_cumulative_days_on_market=reso.get("cumulativeDaysOnMarket"),
            reso_fencing=reso.get("fencing"),
            reso_has_association=reso.get("hasAssociation"),
            reso_has_carport=reso.get("hasCarport"),
            reso_has_pets_allowed=reso.get("hasPetsAllowed"),
            reso_has_waterfront_view=reso.get("hasWaterfrontView"),
            reso_hoa_fee=reso.get("hoaFee"),
            reso_hoa_fee_total=reso.get("hoaFeeTotal"),
            reso_irrigation_water_rights_yn=reso.get("irrigationWaterRightsYN"),
            reso_lease_term=reso.get("leaseTerm"),
            reso_levels=reso.get("levels"),
            reso_list_aor=reso.get("listAOR"),
            reso_living_area_range_units=reso.get("livingAreaRangeUnits"),
            reso_main_level_bathrooms=reso.get("mainLevelBathrooms"),
            reso_main_level_bedrooms=reso.get("mainLevelBedrooms"),
            reso_property_condition=reso.get("propertyCondition"),
            reso_stories_total=reso.get("storiesTotal"),
            reso_structure_type=reso.get("structureType"),
            reso_virtual_tour=reso.get("virtualTour"),
            reso_water_view=reso.get("waterView"),
            reso_water_view_yn=reso.get("waterViewYN"),
            reso_year_built=reso.get("yearBuilt"),
            reso_year_built_effective=reso.get("yearBuiltEffective"),
            reso_zoning=reso.get("zoning"),
            reso_zoning_description=reso.get("zoningDescription"),
            # Additional resoData container fields
            reso_associations=reso.get("associations"),
            reso_door_features=reso.get("doorFeatures"),
            reso_green_building_verification_type=reso.get("greenBuildingVerificationType"),
            reso_green_energy_efficient=reso.get("greenEnergyEfficient"),
            reso_green_energy_generation=reso.get("greenEnergyGeneration"),
            reso_green_water_conservation=reso.get("greenWaterConservation"),
            reso_horse_amenities=reso.get("horseAmenities"),
            reso_media=reso.get("media"),
            reso_other_equipment=reso.get("otherEquipment"),
            reso_other_facts=reso.get("otherFacts"),
            reso_other_parking=reso.get("otherParking"),
            reso_other_structures=reso.get("otherStructures"),
            reso_pool_features=reso.get("poolFeatures"),
            reso_road_surface_type=reso.get("roadSurfaceType"),
            reso_spa_features=reso.get("spaFeatures"),
            reso_utilities=reso.get("utilities"),
