...
_ZP_RESO_MAPPED: set[str] = {
    "stories", "storiesDecimal", "basement", "basementYN",
    ...
    "coveredParkingCapacity", "architecturalStyle",
    ...
    "parkingFeatures", "laundryFeatures", "interiorFeatures",
    "fireplaceFeatures", "patioAndPorchFeatures",
    "propertySubType", "constructionMaterials", "accessibilityFeatures",
    "lotFeatures", "associationFeeIncludes",
    # mapped scalars
    "aboveGradeFinishedArea", "associationFee",
    "fencing", "hasAssociation", "hasCarport",
    "hasWaterfrontView", "hoaFee", "hoaFeeTotal",
    "levels", "listAOR",
    "livingAreaRangeUnits", "mainLevelBedrooms",
    "propertyCondition",
    "waterView", "yearBuilt",
    "zoning",
    # mapped containers
    "associations", "media",
    "utilities", "windowFeatures",
    "inclusions",
}
